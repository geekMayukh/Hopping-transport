...
%pure system hopping 
%=============================================
t_pure_3_pos=t_pure*exp(3.6257-E/(48.0436*kB*T)); %hopping energy for 3 percent in positive bias
t_pure_3_neg=t_pure*exp(0.4508-E/(232.1742*kB*T));%hopping energy for 3 percent in negative bias

t_pure_1_pos=t_pure*exp(3.0257-E/(69.6523*kB*T));%hopping energy for 1 percent in positive bias
...
t_mix_neg=0.0193*8.6*q; %negative bias hopping constant t0
  t_half_neg=0.575*t_mix_neg; %negative bias hopping from 0.5 percent
  t_three_neg= 0.575*t_mix_neg; %negative bias hopping from 3 percent    
%positive bias
 t_half_pos=0.375*t_mix_pos;
t_three_pos=0;
for v=0.1525:(0.7261-0.1525)/10:0.7261
   t_three_pos=t_three_pos+(0.4)*exp(0.1525/6-v/6)*t_mix_pos*heaviside(v-V);
end
